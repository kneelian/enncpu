	...
	for(size_t j = 1; j < lines.size(); j++)
	{
		...
		if(i.OPERATION != NOP)
		{
			...
			switch(i.OPERATION)
			{
				...
				case CGEI_OR: insn |= 0b0'01'0010'000'000000; break;
				case CGEI:    insn |= 0b0'01'0011'000'000000; break;
